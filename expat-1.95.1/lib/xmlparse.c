...
static char RCSId[]
  = "$Header: /data1/home/kim/devel/cvsprojects/nextrieve-2.0.28/expat-1.95.1/lib/xmlparse.c,v 1.1.1.1 2007/07/01 19:58:57 kim Exp $";

#ifdef COMPILED_FROM_DSP
#  include "winconfig.h"
#  define xXMLPARSEAPI __declspec(dllexport)
#  include "expat.h"
#  undef xXMLPARSEAPI
#else
#include <config.h>
